dig.Layers.TutorialFour = dig.Layer.extend({
  text: 'Follow the opposite rules for gold peices!',

  ctor: function () {
    this._super()

    this.setTag(dig.Layers.TutorialFour.TAG)
...
dig.Layers.TutorialFour.TAG = 'tutorial_four_layer'
